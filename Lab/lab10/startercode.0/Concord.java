...
public class Concord {
   ...
   public void printSorted(PrintStream out) {
      ArrayList<Map.Entry<String,Integer>> concordArrayList = new ArrayList<>(concord.entrySet());
      concordArrayList.sort(new concordComparator());

      for (Map.Entry<String, Integer> stringIntegerEntry : concordArrayList) {
...
class concordComparator implements Comparator<Map.Entry<String, Integer>> {
